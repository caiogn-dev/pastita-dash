...
export const NewOrderSteps: React.FC<{ wiz: NewOrderWizard }> = ({ wiz }) => {
  switch (wiz.step) {
    ...
    case 1:
      return <StepEntrega customer={wiz.customer} deliveryMethod={wiz.deliveryMethod} setDeliveryMethod={wiz.setDeliveryMethod} selectedAddress={wiz.selectedAddress} setSelectedAddress={wiz.setSelectedAddress} escolherEnderecoSalvo={wiz.escolherEnderecoSalvo} freeAddressText={wiz.freeAddressText} setFreeAddressText={wiz.setFreeAddressText} routeQuote={wiz.routeQuote} calculatingRoute={wiz.calculatingRoute} onCalculateRoute={wiz.handleCalculateRoute} onUseSharedLocation={wiz.handleUseSharedLocation} customerHasPhone={wiz.customerHasPhone} enableScheduling={wiz.enableScheduling} setEnableScheduling={wiz.setEnableScheduling} scheduledDate={wiz.scheduledDate} setScheduledDate={wiz.setScheduledDate} scheduledTime={wiz.scheduledTime} setScheduledTime={wiz.setScheduledTime} />;
    case 2:
