        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {accounts.length > 0 && (
            <select
              ...
              className="rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 outline-none transition focus:border-[var(--border-focus)] focus:ring-2 focus:ring-[var(--border-focus)] focus:ring-offset-0 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
            >
          ...
          {showSearch && (
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-300 bg-white py-2 pl-10 pr-4 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-[var(--border-focus)] focus:ring-2 focus:ring-[var(--border-focus)]/30 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
              />
            </form>
          )}
