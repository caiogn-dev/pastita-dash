  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={title} size="sm">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button
          type="button"
          className={`px-4 py-2 text-sm font-medium text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 ${variants[variant]}`}
          onClick={onConfirm}
          disabled={isLoading}
        >
