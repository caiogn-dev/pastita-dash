...
interface SwitchProps {
  ...
  size?: 'sm' | 'md' | 'lg';
  className?: string;
  /** Nome acessível do controle. Obrigatório quando não há um rótulo visível associado via ariaLabelledby. */
  ariaLabel?: string;
  /** Id de um elemento visível que rotula o switch (alternativa a ariaLabel). */
