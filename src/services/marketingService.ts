    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          <!-- Header -->
          <tr>
            <td style="background: linear-gradient(135deg, #C9A24B 0%, #D4AF37 100%); padding: 40px; text-align: center;">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <!-- Coupon Box -->
              <div style="background: linear-gradient(135deg, #C9A24B 0%, #D4AF37 100%); border-radius: 12px; padding: 30px; text-align: center; margin: 30px 0;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="{{store_url}}" style="display: inline-block; background: #C9A24B; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-size: 16px; font-weight: bold;">
                  Usar Meu Cupom
                </a>
              </div>
            </td>
