          ...
          <Card title="Detalhes da Conta">
            <div className="space-y-4">
              ...
              {account.default_langflow_flow_id && (
                <div>
                  <p className="text-sm text-gray-500">Flow Langflow Padrão</p>
