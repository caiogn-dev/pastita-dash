...
import { WhatsAppAccount, CreateWhatsAppAccount, LangflowFlow } from '../../types';
...
export const AccountFormPage: React.FC = () => {
  ...
  const loadFlows = async () => {
    try {
      ...
      // Flows are optional, silently fail
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        account = await whatsappService.createAccount(data as unknown as CreateWhatsAppAccount);
