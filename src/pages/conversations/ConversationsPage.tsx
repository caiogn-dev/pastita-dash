  ...
  const columns = [
    {
      ...
      render: (conv: Conversation) => (
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-gray-900">{conv.contact_name || 'Sem nome'}</p>
            <p className="text-sm text-gray-500">{conv.phone_number}</p>
          </div>
        </div>
      ),
    },
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900">{modeCounts.human || 0}</p>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="border-t pt-4 space-y-3 max-h-96 overflow-y-auto">
            {notes.length === 0 ? (
              <p className="text-center text-gray-500 py-4">Nenhuma nota</p>
            ) : (
              notes.map((note) => (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600">{detailConversation.phone_number}</p>
              </div>
            ...
            {conversationOrders[detailConversation.id] && (
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-2">Pedidos do Cliente</h4>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <p className="text-gray-500">Última mensagem</p>
                <p className="font-medium text-gray-900">
