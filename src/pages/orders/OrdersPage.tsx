...
export const OrdersPage: React.FC = () => {
  ...
  const columnData = useMemo(() =>
    COLUMNS.filter(col => !focusColumn || col.id === focusColumn).map(col => ({
      ...
      // ontem é justamente o que precisa aparecer. O "hoje" é o dia no fuso da
      // LOJA (multi-tenant): usar um fuso fixo esconderia os pedidos de hoje de
      // uma loja fora de Brasília.
