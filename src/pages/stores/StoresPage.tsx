    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Gerencie todas as suas lojas e integrações</p>
        </div>
      ...
      {stores.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">Crie sua primeira loja para começar a vender</p>
          <Button onClick={() => setShowCreateModal(true)}>
            <Plus className="w-4 h-4 mr-2" />
            Criar Loja
          </Button>
            ...
            return (
              <Card key={store.id} className="overflow-hidden">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{getStoreTypeLabel(store.store_type)}</p>
                      </div>
                    </div>
                ...
                <div className="p-4 grid grid-cols-3 gap-4 text-center border-b">
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{store.products_count}</p>
                    <p className="text-xs text-gray-500">Produtos</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{store.orders_count}</p>
                    <p className="text-xs text-gray-500">Pedidos</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{store.integrations_count}</p>
