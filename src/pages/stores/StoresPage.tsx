    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Gerencie todas as suas lojas e integrações</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Total de Lojas</p>
      ...
      {stores.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">Crie sua primeira loja para começar a vender</p>
          <Button onClick={() => setShowCreateModal(true)}>
            <Plus className="w-4 h-4 mr-2" />
            Criar Loja
          </Button>
              ...
              <Card key={store.id} className="overflow-hidden">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">{getStoreTypeLabel(store.store_type)}</p>
                      </div>
                    </div>
                ...
                <div className="p-4 grid grid-cols-3 gap-4 text-center border-b">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">Integrações</p>
                  </div>
                </div>
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Nova Loja" size="lg">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipo de Loja</label>
          <select
