      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card className="p-4">
            ...
            <p className="text-2xl font-bold text-purple-600">{stats.products.total}</p>
            <p className="text-xs text-gray-500">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{store.products_count} itens</p>
                </div>
              </Link>
              <Link
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{store.orders_count} pedidos</p>
                </div>
              </Link>
              <Link
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Gerenciar descontos</p>
                </div>
              </Link>
              <Link
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Zonas e taxas</p>
                </div>
              </Link>
            </div>
          </Card>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="pt-3 border-t">
                <p className="text-sm text-gray-500">Configurações de Entrega</p>
