...
import { CompanyProfile, UpdateCompanyProfile, BusinessHours, BusinessType } from '../../types';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{profile.account_phone}</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Automation Settings */}
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Configurações de Automação</h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <label className="text-sm font-medium text-gray-700">Respostas Automáticas</label>
                <p className="text-sm text-gray-500">Habilitar respostas automáticas para mensagens</p>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Enviar boas-vindas na primeira mensagem</p>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                <label className="text-sm font-medium text-gray-700">Enviar Cardápio Automaticamente</label>
                <p className="text-sm text-gray-500">Enviar cardápio junto com boas-vindas</p>
              </div>
              <input
                type="checkbox"
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <label className="text-sm font-medium text-gray-700">Carrinho Abandonado</label>
                <p className="text-sm text-gray-500">Notificar quando cliente abandona carrinho</p>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                <label className="text-sm font-medium text-gray-700">PIX Gerado</label>
                <p className="text-sm text-gray-500">Notificar quando PIX é gerado</p>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                <label className="text-sm font-medium text-gray-700">Confirmação de Pagamento</label>
                <p className="text-sm text-gray-500">Notificar quando pagamento é confirmado</p>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                <label className="text-sm font-medium text-gray-700">Status do Pedido</label>
                <p className="text-sm text-gray-500">Notificar mudanças no status do pedido</p>
              </div>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Notificar sobre entrega</p>
              </div>
              <input
                type="checkbox"
        ...
        {/* API Integration */}
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Integração API</h2>
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-1 flex rounded-md shadow-sm">
                ...
                <button
                  ...
                  className="inline-flex items-center px-3 border border-l-0 border-gray-300 bg-gray-50 text-gray-500 hover:text-gray-700"
                >
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Integração Langflow</h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <label className="text-sm font-medium text-gray-700">Usar Langflow</label>
                <p className="text-sm text-gray-500">Usar Langflow para respostas avançadas com IA</p>
              </div>
              <input
                type="checkbox"
