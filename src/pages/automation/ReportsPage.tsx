...
import { whatsappService, companyProfileApi, getErrorMessage } from '../../services';
import {
  ReportSchedule,
  ...
  const handleGenerateReport = async () => {
    try {
      ...
      await generatedReportsService.generate({
        report_type: generateData.report_type as ReportType,
        ...
        recipients,
        export_format: generateData.export_format as 'csv' | 'xlsx',
      });
      toast.success('Relatório sendo gerado...');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Relatórios Automatizados</h1>
          <p className="text-gray-600">Configure relatórios periódicos e gere sob demanda</p>
        </div>
