    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Configure relatórios periódicos e gere sob demanda</p>
        </div>
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Hora de Envio</label>
            <select
              className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              value={formData.hour}
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {formData.recipients.map((email) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="ml-1 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 dark:hover:text-gray-300"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center pt-6">
              ...
              />
              <label htmlFor="include_charts" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Incluir gráficos
              </label>
            </div>
          </div>
