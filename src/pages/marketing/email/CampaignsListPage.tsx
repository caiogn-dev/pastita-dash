    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      {campaigns.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-500 mb-6">Crie sua primeira campanha de email marketing</p>
          <Button onClick={() => navigate('/marketing/email/new')}>
            <PlusIcon className="w-5 h-5 mr-2" />
            Criar Campanha
          </Button>
                  ...
                  {campaign.status === 'sent' && (
                    <div className="flex items-center gap-6 px-4 py-2 bg-gray-50 rounded-lg">
                      <div className="text-center">
                        <p className="text-lg font-bold text-gray-900">{campaign.emails_sent}</p>
      ...
      >
        {loadingRecipients ? (
          <div className="py-12 text-center">
            ...
            <p className="text-gray-500">Carregando destinatários...</p>
          </div>
        ) : recipients.length === 0 ? (
          <div className="py-12 text-center">
              ...
              <table className="w-full">
                <thead className="bg-gray-50 sticky top-0">
                  <tr>
                    ...
                    <th className="text-left text-xs font-medium text-gray-500 px-4 py-2">Nome</th>
                    <th className="text-left text-xs font-medium text-gray-500 px-4 py-2">Status</th>
                    <th className="text-left text-xs font-medium text-gray-500 px-4 py-2">Enviado em</th>
                    <th className="text-left text-xs font-medium text-gray-500 px-4 py-2">Erro</th>
                  </tr>
                </thead>
