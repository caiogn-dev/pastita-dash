    ...
    <Card className="group overflow-hidden hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="relative aspect-square bg-gray-100 dark:bg-gray-700">
        ...
        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
          <button
            onClick={onEdit}
            className="p-2 bg-white dark:bg-[var(--dark-bg-card,#1a1a1a)] rounded-full hover:bg-gray-100 dark:hover:bg-[var(--dark-bg-hover,#161616)] transition-colors"
            title="Editar"
          >
            <PencilIcon className="w-5 h-5 text-gray-700 dark:text-[var(--dark-text-secondary,#a1a1aa)]" />
          </button>
          <button
            onClick={onDuplicate}
            className="p-2 bg-white dark:bg-[var(--dark-bg-card,#1a1a1a)] rounded-full hover:bg-gray-100 dark:hover:bg-[var(--dark-bg-hover,#161616)] transition-colors"
            title="Duplicar"
          >
            <DocumentDuplicateIcon className="w-5 h-5 text-gray-700 dark:text-[var(--dark-text-secondary,#a1a1aa)]" />
          </button>
          <button
            onClick={onDelete}
        ...
        <button
          ...
          className="absolute top-2 right-2 p-1.5 bg-white dark:bg-[var(--dark-bg-card,#1a1a1a)] rounded-full shadow-sm hover:shadow-md transition-shadow"
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 mb-2">
          {product.category_name && (
            <span className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded">
              {product.category_name}
            </span>
          )}
        ...
        {/* SKU */}
        <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] mb-2">SKU: {product.sku}</p>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] hover:text-gray-700 dark:hover:text-[var(--dark-text-primary,#FAF9F7)]"
          >
...
const ProductRow: React.FC<ProductRowProps> = ({
  ...
  return (
    <tr className="hover:bg-gray-50 dark:hover:bg-[var(--dark-bg-hover,#161616)] dark:bg-black transition-colors">
      <td className="px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">SKU: {product.sku}</p>
          </div>
        </div>
      </td>
      <td className="px-4 py-3">
        <div className="flex flex-col gap-1">
          {product.category_name && (
            <span className="text-xs text-gray-600 dark:text-[var(--dark-text-secondary,#a1a1aa)]">{product.category_name}</span>
          )}
          {product.product_type_name && (
      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-1">
          <button
            onClick={onEdit}
            className="p-1.5 hover:bg-gray-100 dark:hover:bg-[var(--dark-bg-hover,#161616)] dark:bg-gray-700 rounded-lg transition-colors"
            title="Editar"
          >
            <PencilIcon className="w-4 h-4 text-gray-600 dark:text-[var(--dark-text-secondary,#a1a1aa)]" />
          </button>
          <button
            onClick={onDuplicate}
            className="p-1.5 hover:bg-gray-100 dark:hover:bg-[var(--dark-bg-hover,#161616)] dark:bg-gray-700 rounded-lg transition-colors"
            title="Duplicar"
          >
            <DocumentDuplicateIcon className="w-4 h-4 text-gray-600 dark:text-[var(--dark-text-secondary,#a1a1aa)]" />
          </button>
          <button
            onClick={onDelete}
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit}>
        {/* Tabs */}
        <div className="flex border-b border-gray-200 dark:border-[var(--dark-border,#2a2a2a)] mb-6 -mx-6 px-6">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            return (
              <button
        ...
        <div className="space-y-6 max-h-[60vh] overflow-y-auto px-1">
            ...
            <div className="space-y-4">
              ...
              {selectedProductType && selectedProductType.custom_fields.length > 0 && (
                <div className="border-t pt-4 mt-4">
                  <h4 className="text-sm font-medium text-gray-700 dark:text-[var(--dark-text-primary,#FAF9F7)] mb-3">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">R$</span>
                    <input
                      type="number"
                      value={formData.price || ''}
                      onChange={(e) => setFormData(prev => ({ ...prev, price: Number(e.target.value) }))}
                      className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-[var(--dark-border,#2a2a2a)] rounded-lg focus:ring-2 focus:ring-primary-500"
                      step="0.01"
                      min="0"
                      required
                    />
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] mt-1">Para mostrar desconto</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-[var(--dark-text-primary,#FAF9F7)] mb-1">
                    Custo
                  ...
                  <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] mt-1">Para cálculo de margem</p>
                </div>
              </div>
              ...
              {formData.price > 0 && formData.cost_price && formData.cost_price > 0 && (
                <Card className="p-4 bg-gray-50 dark:bg-black">
                  <h4 className="text-sm font-medium text-gray-700 dark:text-[var(--dark-text-primary,#FAF9F7)] mb-2">Análise de Margem</h4>
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <p className="text-2xl font-bold text-green-600 dark:text-green-400">
                        {formatMoney(formData.price - formData.cost_price)}
                      </p>
                      <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Lucro Bruto</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                        {(((formData.price - formData.cost_price) / formData.price) * 100).toFixed(1)}%
                      </p>
                      <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Margem</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                        {(((formData.price - formData.cost_price) / formData.cost_price) * 100).toFixed(1)}%
                      </p>
                      <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Markup</p>
                    </div>
                  </div>
                </Card>
              )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-40 h-40 bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-[var(--dark-border,#2a2a2a)]">
                    {imagePreview ? (
                  ...
                  <div className="flex-1">
                    ...
                    <label
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-[var(--dark-bg-card,#1a1a1a)] border border-gray-300 dark:border-[var(--dark-border,#2a2a2a)] rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-[var(--dark-bg-hover,#161616)] transition-colors"
                    >
                      <PhotoIcon className="w-5 h-5" />
                      Escolher Imagem
                    </label>
                    <p className="text-xs text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] mt-2">
          ...
          {activeTab === 'seo' && (
            <div className="space-y-4">
              ...
              {/* SEO Preview */}
              <Card className="p-4 bg-gray-50 dark:bg-black">
                <h4 className="text-sm font-medium text-gray-700 dark:text-[var(--dark-text-primary,#FAF9F7)] mb-2">Prévia no Google</h4>
                <div className="bg-white dark:bg-[var(--dark-bg-card,#1a1a1a)] p-3 rounded border">
                  ...
                  <p className="text-gray-600 dark:text-[var(--dark-text-secondary,#a1a1aa)] text-sm line-clamp-2">
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-[var(--dark-border,#2a2a2a)]">
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-5 max-md:grid-cols-2 gap-4">
        ...
        <Card className="p-4 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Estoque Baixo</p>
        </Card>
        <Card className="p-4 text-center">
          <p className="text-3xl font-bold text-red-600 dark:text-red-400">{stats.outOfStock}</p>
          <p className="text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Sem Estoque</p>
        </Card>
        <Card className="p-4 text-center">
          <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">{stats.featured}</p>
          <p className="text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Destaques</p>
        </Card>
      </div>
        ...
        <div className="flex flex-row max-md:flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <select
              ...
              className="px-3 py-2 border border-gray-300 dark:border-[var(--dark-border,#2a2a2a)] rounded-lg focus:ring-2 focus:ring-primary-500 text-sm"
            >
            ...
            <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
              <button
                ...
                className={`p-1.5 rounded ${viewMode === 'grid' ? 'bg-white dark:bg-gray-700 shadow-sm' : 'text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]'}`}
              >
                <Squares2X2Icon className="w-5 h-5" />
              </button>
              <button
                onClick={() => setViewMode('list')}
                className={`p-1.5 rounded ${viewMode === 'list' ? 'bg-white dark:bg-gray-700 shadow-sm' : 'text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]'}`}
              >
        ...
        <Card className="overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-black border-b">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] uppercase">Produto</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] uppercase">Categoria/Tipo</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] uppercase">Preço</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] uppercase">Estoque</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] uppercase">Status</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] uppercase">Destaque</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)] uppercase">Ações</th>
              </tr>
            </thead>
