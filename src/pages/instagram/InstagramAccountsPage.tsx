  ...
  if (loading) {
    return (
      <div className="p-6">
        <div className="py-12">
          <Loading />
          <p className="mt-4 text-center text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">
            Carregando contas...
          </p>
        </div>
      </div>
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">Instagram</h1>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Contas Conectadas</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Total de Seguidores</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Contas Verificadas</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">
                {verifiedAccounts}
              </p>
            </div>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-[var(--dark-text-secondary,#a1a1aa)]">Midias Totais</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">
      ...
      <Card>
        <div className="border-b border-gray-200 p-4 dark:border-[var(--dark-border,#2a2a2a)]">
        ...
        {accounts.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <h3 className="mb-2 text-lg font-medium text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">
          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            {accounts.map((account) => (
              <div
                key={account.id}
                className="p-4 transition-colors hover:bg-gray-50 dark:hover:bg-[var(--dark-bg-hover,#161616)]"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">
                        @{account.username}
                      </h3>
                      {account.is_verified && (
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-[var(--dark-text-secondary,#a1a1aa)]">
                      {account.biography || 'Sem biografia'}
                    </p>

                    <div className="mt-3 flex flex-wrap gap-4 text-sm">
                      <span className="text-gray-600 dark:text-[var(--dark-text-secondary,#a1a1aa)]">
                        <strong className="text-gray-900 dark:text-[var(--dark-text-primary,#FAF9F7)]">
      ...
      >
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="mb-6 text-gray-600 dark:text-[var(--dark-text-secondary,#a1a1aa)]">
