        ...
        <div className="px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Gerencie informações e configurações de entrega</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none font-mono"
                  placeholder="-10.1857"
                />
              </div>
              <div>
          ...
          <div className="p-5 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Valor mínimo cobrado</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Taxa por Km (R$)
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none"
                />
                <p className="text-xs text-gray-500 mt-1">Valor adicional por km após o limite grátis</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Km Grátis
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none"
                />
                <p className="text-xs text-gray-500 mt-1">Distância sem cobrança adicional</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Taxa Máxima (R$)
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none"
                />
                <p className="text-xs text-gray-500 mt-1">Limite máximo da taxa de entrega</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5">
              ...
              <div className="bg-white rounded-lg p-4 font-mono text-sm border border-gray-200">
                <p className="text-gray-700">
                  Se distância ≤ {deliveryConfig.delivery_free_km} km: <span className="text-green-600 font-bold">R$ {deliveryConfig.delivery_base_fee.toFixed(2)}</span>
                </p>
                <p className="text-gray-700 mt-2">
                  Se distância &gt; {deliveryConfig.delivery_free_km} km: <span className="text-amber-600 font-bold">R$ {deliveryConfig.delivery_base_fee.toFixed(2)} + (distância - {deliveryConfig.delivery_free_km}) × R$ {deliveryConfig.delivery_fee_per_km.toFixed(2)}</span>
                </p>
                <p className="text-gray-700 mt-2">
                  Máximo: <span className="text-red-600 font-bold">R$ {deliveryConfig.delivery_max_fee.toFixed(2)}</span>
                </p>
              </div>
            </div>
            ...
            <div className="bg-amber-50 rounded-xl p-5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[2, 5, 8, 12].map((km) => (
                  <div key={km} className="bg-white rounded-lg p-3 text-center border border-amber-200">
                    <p className="text-sm text-gray-500">{km} km</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-pink-50">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Status da Loja</h2>
              </div>
            </div>
            <div className="p-5">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-lg font-bold text-blue-600">{store.products_count || 0}</p>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-xl">
                  <p className="text-sm text-gray-500">Pedidos</p>
                  <p className="text-lg font-bold text-purple-600">{store.orders_count || 0}</p>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-xl">
