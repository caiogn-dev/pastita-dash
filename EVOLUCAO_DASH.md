...
- `npm test`: **1806/301 → 1808/301** verdes (+2 testes desta fatia).
...
- **Antes/depois:** `npm test` 1806/301 → **1808/301**; `tsc --noEmit` limpo nos dois
  lados; `eslint` **0 erros/0 warnings** no arquivo de produção tocado. Só produção
  alterada: ramo de erro no lugar do estado vazio enganoso, risco baixo.
