...
### Coupons Management
**Backend pronto:** Models e endpoints de validação existem, falta CRUD admin
- [ ] **Criar página:** `src/pages/coupons/CouponsPage.tsx`
- [ ] **Criar service:** `src/services/coupons.ts`
- [ ] **Funcionalidades:**
...
### Products Management
- [ ] **Criar página:** `src/pages/products/ProductsPage.tsx`
- [ ] **Funcionalidades:**
  - [ ] List products with filters (category, stock, active)
  - [ ] Create product form
  - [ ] Edit product
  - [ ] Delete product
  - [ ] Image upload
...
| Orders Management | ✅ Complete | 95% |
| Payments | ✅ Complete | 85% |
| Payment Gateways | ✅ Complete | 100% |
| WhatsApp Accounts | ✅ Complete | 90% |
| Messages | ✅ Complete | 80% |
| Conversations | ✅ Complete | 85% |
| Automation | ✅ Complete | 90% |
| Langflow | ✅ Complete | 80% |
| Dashboard Overview | ✅ Complete | 70% |
| Dashboard Charts | 🟡 Partial | 30% |
| Coupons | 🔴 TODO | 0% |
| Delivery Zones | 🔴 TODO | 0% |
| Products | 🔴 TODO | 0% |
| Export UI | 🟡 Partial | 20% |
...
1. **Backend:** Criar endpoints admin para Coupons e DeliveryZones
2. **Frontend:** Criar páginas de Coupons e DeliveryZones
3. **Frontend:** Criar página de Products
4. **Frontend:** Melhorar Dashboard com charts
5. **Frontend:** Implementar Export UI
